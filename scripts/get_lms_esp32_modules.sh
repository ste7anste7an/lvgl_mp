...
git clone https://github.com/antonvh/np_animation
git clone https://github.com/antonvh/rcservo
...
mkdir -p $LMS_ESP32_MODULES/btbricks
cp ../submodules/btbricks/btbricks/*.py $LMS_ESP32_MODULES/btbricks
